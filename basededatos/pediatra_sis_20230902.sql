...
INSERT INTO `detalle_historia_clinica` VALUES (1,1,3,'SSDSDS','2023-07-13'),(2,2,6,'hola','2023-07-11'),(3,2,9,'SASD','2023-07-09'),(4,3,3,'AASAsas','2023-07-11'),(5,3,11,'MODF','2023-06-29'),(6,4,3,'AASAsas','2023-07-12'),(7,5,7,'ssss','2023-07-05'),(8,6,3,'SASD','2023-07-18'),(9,7,4,'AASAsas','2023-07-13'),(10,8,3,'AASAsas','2023-07-20'),(11,9,3,'MODIF','2023-07-19');
...
INSERT INTO `historia_clinica` VALUES (1,5),(2,6),(3,7),(4,8),(5,9),(6,11),(7,14),(8,16),(9,19);
...
CREATE TABLE `localizador_padres_de_pacientes` (
  ...
  `Identificador` varchar(30) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `nino_padre` (
  ...
  `ID_Padre` varchar(30) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `Tipo_Padre` enum('Padre','Madre','Tutor Legal') COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `pacientes_vacunas` VALUES (1,6,0,'1era','NA',''),(2,6,0,'2da','NA',''),(3,7,0,'3ra','NA',''),(4,7,0,'1era','NA',''),(5,8,7,'8va','1er','2023-07-12'),(6,9,3,'2da','NA','fecha_no_provista'),(7,11,7,'1era','1er','fecha_no_provista'),(8,16,1,'1era','1er','2023-07-20'),(9,19,3,'1era','1er','2023-07-07');
...
INSERT INTO `seguro` VALUES (1,'ARS Universal'),(2,'ARS Palic'),(3,'ARS Humano'),(4,'ARS Senasa'),(5,'ARS Mapfre Salud'),(6,'ARS Monumental'),(7,'ARS Renacer'),(8,'ARS Meta Salud'),(9,'ARS Futuro'),(10,'ARS Semma'),(11,'Ars Banreservas');
...
INSERT INTO `seguro_paciente` VALUES ('',3,0),('',2,0),('2587272728',1,2),('',4,0),('g988987989',5,10),('889895269',6,4),('872698855',7,2),('54556888',8,3),('5555888',9,10),('Array',10,0),('Array',11,0),('5689898',12,3),('1',13,10),('5689898',14,2),('5689898',15,2),('5689898',16,2),('5689898',17,10),('5689898',18,4),('5689898',19,4),('5689898',20,2);
...
-- Dump completed on 2023-09-02 10:55:39
