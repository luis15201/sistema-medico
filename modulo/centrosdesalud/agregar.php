            ...
            <form name="miFormulario" class="contenedor_popup" method="POST" onsubmit="return validarFormulario()">
                <fieldset class="caja">
                    ...
                    <div><label>Nombre del centro</label>
                        <input type="text" autofocus name="txtnom" autocomplete="off" required>
                    </div>
                    <br>
                    <div><label>Direccion</label>
                        <input type="text" name="txtdire" autocomplete="off" required>
                    </div>
                    <br>
                    <div><label>Telefono</label>
                        <input type="text" name="txttele" autocomplete="off" required>
                    </div>
                    <br>
                ...
                <div class="botones-container">
                    ...
                    <button type="submit" name="btnregistrar" value="Registrar" onClick="javascript: return confirm('¿Deseas registrar a este *NUEVO* Centro de Salud');"> <i class="material-icons" style="font-size:21px;color:#12f333;text-shadow:2px 2px 4px #000000;">add</i> Registrar</button>


                    <?php echo "<a class='boton' href=\"../../mant-centromedico.php?pag=$pagina\">
