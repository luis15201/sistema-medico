                ...
                <fieldset class="caja">
                  ...
                  <div>
					...
					<div>
						...
						<input type="text" id="id_paciente" name="id_paciente" style="width: 115px;" value="<?php echo $idpaciente; ?>" required>
                  ...
                  <div>
                    ...
                    <p>
						...
						<input type="date" autofocus name="txtfecha" id="txtfecha" value="<?php echo $fecha; ?>" required>
                        <!-- <input type="text" name="txtdescripcion" id="txtdescripcion" value="<?php //echo $vacunades; 
                                                                                                    ?>" required> -->
                    </p>
                    ...
                    <p>
						...
						<input type="time" autofocus name="txthora" id="txthora" value="<?php echo $hora; ?>" required>
                        <!-- <input type="text" name="txtdescripcion" id="txtdescripcion" value="<?php //echo $vacunades; 
                                                                                                    ?>" required> -->
                    </p>
                    ...
                    <p>
						...
						<textarea name="txtdescripcion" id="txtdescripcion" required><?php echo $observaciones; ?></textarea>
                        <!-- <input type="text" name="txtdescripcion" id="txtdescripcion" value="<?php //echo $vacunades; 
                                                                                                    ?>" required> -->
                    </p>
...
if (isset($_POST['btnmodificar'])) {
    ...
    $querymodificar = mysqli_query($conn, "UPDATE citas SET id_cita='$idcita',id_medico='$medico', id_paciente='$paciente', fecha='$fecha', hora='$hora',observaciones='$observacion',Estado='$estado' WHERE id_cita= $idcita ");
    echo "<script>window.location= '../../proces_citas.php?pag=$pagina' </script>";
}
?>