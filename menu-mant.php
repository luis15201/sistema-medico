...
<body >
  ...
  <div class="card-wrapper">
    <div class="card" style="background: linear-gradient(to right, #e4e5dc, #62c4f9); ">
      ...
      <div class="card-description"><p> En este apartado tenemos lo referente a Pacientes.</p></div>
    </div>
  </div>
  </a>
  ...
  <div class="card-title" style="font-family: Arial Black; color:black;">Seguros</b></div>
    ...
    <div class="card-description"><p> Aquí podemos registrar las aseguradoras de salud.</p></div>
  </div>
  </div>
</a>
