...
<body>
  ...
  <script>
    ...
    $(document).ready(function() {
      var tablalocalizadorm = $('#tabla_localizador').DataTable();
      // Asignar un evento de clic a las filas de la tabla
      $('#tabla_localizador tbody').on('click', 'tr', function() {
        // Obtener la fila clicada
        var fila = $(this);
        // Obtener los datos de las celdas
        var ide = tablalocalizador.row(fila).data()[0];
        var nombreespecialidad = tablalocalizador.row(fila).data()[1];
