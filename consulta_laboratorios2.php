...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
  ...
  <script>
    $(document).ready(function() {
      ...
      var table = $('#tabla_laboratorios').DataTable();
      $('#tabla_laboratorios').on('click', 'tr', function() {
    ...
    function seleccionarLaboratorio(idLaboratorio, nombreLaboratorio) {
      var openerWindow = window.opener;
      openerWindow.document.getElementById("Id_laboratorio").value = idLaboratorio;
      openerWindow.document.getElementById("Nombre_laboratorio").textContent = nombreLaboratorio;
      window.close();
    }
  </script>
</head>
...
<body>
  <table id="tabla_laboratorios" class="display" style="width:100%">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          echo "<tr onclick=\"seleccionarLaboratorio('" . $row["id_laboratorio"] . "', '" . $row["nombre_laboratorio"] . "')\">";
  ...
  <script>
    ...
    $(document).ready(function() {
      var tablaLaboratorios = $('#tabla_laboratorios').DataTable();
      // Asignar un evento de clic a las filas de la tabla
      $('#tabla_laboratorios tbody').on('click', 'tr', function() {
        // Obtener la fila clicada
        var fila = $(this);
        // Obtener los datos de las celdas
        var idLaboratorio = tablaLaboratorios.row(fila).data()[0];
        var nombreLaboratorio = tablaLaboratorios.row(fila).data()[1];
