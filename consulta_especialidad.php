  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#tabla_especialidad tbody').on('click', 'tr', function() {
        ...
        window.parent.document.getElementById('id_especialidad').value = idLaboratorio;
        window.parent.document.getElementById('especialidad').textContent = nombreLaboratorio;
