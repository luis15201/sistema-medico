...
// Consulta para obtener los datos de la tabla "Padecimientos"
        ...
        <div class="container">
            ...
            <form method="POST">
                ...
                <fieldset style=" height:800px;">
                    ...
                    <a href="modulo/Padecimiento/agregar.php" id="btnatras" class="btn btn-primary boton" style="width: 120px;vertical-align: baseline; font-weight:bold;">
            ...
            <div height="600px">
                <iframe id="modal-iframe" src="consulta_Padecimientos2.php" frameborder="0" style="width: 100%; height: 100%; max-height:670px;"></iframe>
            </div>         
