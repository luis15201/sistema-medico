...
<body>
    ...
    <div class="cont">
        ...
        <legend>Lista de usuarios</legend>
            ...
            <a  class='claseboton' href="menu_mant.php">Volver al menu</a>
            <a  class='claseboton' href="agregaruser.php">Inicio</a>
    ...
    <a class='claseboton' href="menu.php">Volver al menu</a>
